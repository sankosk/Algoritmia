...
// DEL ÁRBOL DE DESARROLLO DE ESTADOS DEL PROBLEMA.
// HABRÁ QUE CONCRETAR ESTA CLASE PARA CADA PROBLEMA 
// (Implementando los métododos abstractos)
...
public abstract class Estado implements Comparable<Estado> 
{
	...
	/**
	 * Devuelve valor del heurístico correspondiente al estado
	...
	/**
	 * Profundidad del árbol a la que se encuentra el estado,
	 * esto se corresponde con el número de elemento completado 
	 * en la tupla de la solución parcial
	 ...
	 * el montículo de Ramificación y poda
	 */
	@Override
